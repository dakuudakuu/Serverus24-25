...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 0.0029523018728665;
        public double lateralInPerTick = 0.001982846044789733;
        public double trackWidthTicks = 3807.2404287903278;

        // feedforward parameters (in tick units)
        public double kS = 1.5794412676989134;
        public double kV = 0.00036461936124450154;
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftBack = hardwareMap.get(DcMotorEx.class, "motor3");
